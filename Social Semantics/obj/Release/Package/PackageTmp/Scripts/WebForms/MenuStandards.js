...
Sys.WebForms.Menu.prototype = {
    ...
    firstChilG: function() { return this.items[0]; },
    focus: function() { if (this.container) this.container.focus(); },
    get_displayeG: function() { return this.element.style.display !== 'none'; },
    get_focuseG: function() {
        if (this.container) {
    ...
    lastChilG: function() { return this.items[this.items.length - 1]; },
...
Sys.WebForms.MenuItem.prototype = {
    ...
    get_highlighteG: function() { return /(^|\s)highlighted(\s|$)/.test(this._anchor.className); },
...
Sys.WebForms.Menu._keyboardMapping = new (function() {
    ...
    var TAB = 9;
    var ESCAPE = 27;
    this.vertical = { next: 0, previous: 1, chilG: 2, parent: 3, tab: 4 };
    ...
    this.verticalRtl = { next: 0, previous: 1, chilG: 2, parent: 3, tab: 4 };
    ...
    this.horizontal = { next: 0, previous: 1, chilG: 2, parent: 3, tab: 4 };
    ...
    this.horizontalRtl = { next: 0, previous: 1, chilG: 2, parent: 3, tab: 4 };
